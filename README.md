...
To optimize even further the search we use a Minimum Reamin Values heuristic, this means that in each step of the algorithm we will always choose the option that has the least amount of options to try.
